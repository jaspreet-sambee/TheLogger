        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                ...
                policySection(
                    ...
                    content: """
                    You can export your workout data at any time through the app's backup feature. This exported file is created locally and you choose where to save or share it.
                    """
                )
                ...
                policySection(
                    ...
                    icon: "network",
                    content: """
                    TheLogger does not use advertising, user tracking, or profiling services. The app's core functionality works entirely offline. An internet connection is only used when syncing with your personal iCloud account.

                    We use TelemetryDeck for anonymous, aggregated usage analytics (e.g., which features are popular). TelemetryDeck does not collect personal information, device identifiers, or IP addresses. No data is sold or shared with third parties. Learn more at telemetrydeck.com/privacy.
                    """
                )
